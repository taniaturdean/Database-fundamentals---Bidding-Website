...
<?php
  ...
  if (isset($_SESSION['logged_in']) && $_SESSION['logged_in'] == true) {
    ...
    echo "<a class='nav-link' href='my_account.php'></span>Hi, $username!</a>";
...
<?php
  ...
  if (isset($_SESSION['account_type']) && $_SESSION['account_type'] == 'buyer') {
    echo '<li class="nav-item mx-1"> <a class="nav-link" href="mybids.php">My Bids</a> </li>
	  <li class="nav-item mx-1"> <a class="nav-link" href="recommendations.php">Recommended</a></li>
    <li class="nav-item mx-1"> <a class="nav-link" href="purchases.php">My Purchases</a></li>';
  }
  ...
  elseif (isset($_SESSION['account_type']) && $_SESSION['account_type'] == 'both') {
    echo '<li class="nav-item mx-1"> <a class="nav-link" href="mybids.php">My Bids</a> </li>
	  <li class="nav-item mx-1"> <a class="nav-link" href="recommendations.php">Recommended</a></li>
    <li class="nav-item mx-1"> <a class="nav-link" href="purchases.php">My Purchases</a></li>';
    echo '<li class="nav-item mx-1"> <a class="nav-link" href="mylistings.php">My Listings</a> </li>
  ...
  if (isset($_SESSION['logged_in'])) {
    echo '<li class="nav-item mx-1"> <a class="nav-link" href="my_account.php">My Account</a> </li>';
  }
